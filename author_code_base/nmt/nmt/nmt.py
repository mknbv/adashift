...
def add_arguments(parser):
  ...
  # optimizer
  parser.add_argument("--optimizer", type=str, default="sgd", help="sgd | adam | adaShift | amsgrad")
  ...
  parser.add_argument(
      ...
      How we decay learning rate. Options include:
        ...
        self: after 8000 train steps, we start halving the learning rate every 1000 steps.
        ming: after 8000 train steps, we start halving the learning rate every 3000 steps.
      """)
  parser.add_argument(
  ...
  parser.add_argument("--use_mov", type=int, default=0, help="set to 0, not use move in adashift optimizer; "
                                                             "set to 1, use move in adashift optimizer")
  parser.add_argument("--mov_num", type=int, default=10, help="mov_num of adashift optimizer")
...
def create_hparams(flags):
  ...
  return tf.contrib.training.HParams(
      ...
      keep_num=flags.keep_num,
      pred_g_op=flags.pred_g_op,
      use_mov=flags.use_mov,
      mov_num=flags.mov_num,
